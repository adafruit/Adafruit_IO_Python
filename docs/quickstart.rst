...
If you want to be notified of feed changes immediately without polling, consider using the MQTT client. See ``examples/mqtt/mqtt_client_class.py`` for an example of using the MQTT client.

For Adafruit IO service integrations (Time, Random Data, Weather, and Air Quality), see :doc:`integrations`.
